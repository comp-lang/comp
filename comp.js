...
//const set_flag_old = funcs.build(
//  [wasm.i32, wasm.i32, wasm.i32], [wasm.i32], {},
...
const func_tbl_idx = pre_new_method(1, 0, 0, wasm.i32, {});

func_tbl_idx.implement(types.Function, types.Function.fields.tbl_idx.func_idx);

func_tbl_idx.implement(types.VariadicFunction, function (func) {
  return [
    wasm.local$get, ...func,
...
const get = pre_new_method(3, 0, 0, wasm.i32, { comp: "get" }),
      ...
      first = pre_new_method(1, 0, 0, wasm.i32, {}),
      rest = pre_new_method(1, 0, 0, wasm.i32, {}),
      count = pre_new_method(1, 0, 0, wasm.i32, {
        comp: "count",
        comp_wrapper: [wrap_result_i32_to_int]
      }),
// todo: specify start idx
      for_each = pre_new_method(4, 0, 0, wasm.i32, {}),
...
const call_for_each = funcs.build(
  ...
  function (val, accum, idx, func) {
    return [
      ...
      wasm.local$get, ...func,
      wasm.call, ...func_tbl_idx.uleb128,
      wasm.call_indirect, ...sleb128i32(get_type_idx(4, 0, 0, wasm.i32)), 0,
      wasm.local$get, ...idx,
      wasm.call, ...free.uleb128
    ];
  }
...
const refs_array_for_each = funcs.build(
  [wasm.i32, wasm.i32, wasm.i32, wasm.i32, wasm.i32],
  [wasm.i32], {},
  function (arr, accum, idx, accum_idx, func) {
...
for_each.implement(types.RefsArray, function (arr, accum, idx, func) {
  return [
    wasm.local$get, ...arr,
    wasm.local$get, ...accum,
    wasm.local$get, ...idx,
...
const vec_node_for_each = funcs.build(
  [wasm.i32, wasm.i32, wasm.i32, wasm.i32, wasm.i32, wasm.i32],
  [wasm.i32], {},
  function (vec, node, accum, n, shift, func) {
    const idx = this.local(wasm.i32),
          len = this.local(wasm.i32),
...
for_each.implement(types.Vector, function (vec, accum, idx, func) {
...
// todo: use idx
function map_node_for_each (node, accum, n, func) {
  const arr = this.local(wasm.i32),
        idx = this.local(wasm.i32),
        len = this.local(wasm.i32);
  return [
...
for_each.implement(types.LeafNode, function (node, accum, idx, func) {
  return [
    wasm.local$get, ...node,
    wasm.local$get, ...accum,
    wasm.local$get, ...idx,
...
for_each.implement(types.HashMap, function (map, accum, idx, func) {
  return [
    wasm.local$get, ...map,
    wasm.call, ...types.HashMap.fields.root.uleb128,
    wasm.local$get, ...accum,
...
map_node_lookup.implement(types.LeafNode, function (
  ...
  return [
//wasm.local$get, ...key,
//wasm.i32$const, ...sleb128i32(51096),
//wasm.i32$eq,
//wasm.if, wasm.void,
//wasm.i32$const, ...sleb128i32(50644),
//wasm.call, ...hash.uleb128,
...
//wasm.call, ...print_i32.uleb128,
//wasm.i32$const, nil,
//wasm.i32$const, ...sleb128i32(js_string_to_comp("invoke")),
...
for_each.implement(types.Seq, function (seq, accum, idx, func) {
  return [
    wasm.local$get, ...seq,
    wasm.call, ...types.Seq.fields.root.uleb128,
    wasm.local$get, ...accum,
...
for_each.implement(types.ConsSeq, function (seq, accum, idx, func) {
  return [
    wasm.local$get, ...seq,
    wasm.call, ...types.ConsSeq.fields.first.uleb128,
    wasm.local$get, ...accum,
...
for_each.implement(types.ConcatSeq, function (seq, accum, idx, func) {
  return [
    wasm.local$get, ...seq,
    wasm.call, ...types.ConcatSeq.fields.left.uleb128,
    wasm.local$get, ...accum,
...
for_each.implement(types.VectorSeq, function (seq, accum, idx, func) {
...
for_each.implement(types.RefsArraySeq, function (seq, accum, idx, func) {
  return [
    wasm.local$get, ...seq,
    wasm.call, ...types.RefsArraySeq.fields.arr.uleb128,
    wasm.local$get, ...accum,
...
// todo: merge keyword & symbol stores
...
function make_keyword (nm) {
  if (typeof nm === "string") nm = cached_string(nm);
  let out = keywords[nm];
  if (out) return out;
  return keywords[nm] = comp.keyword(0, nm);
}
...
const make_symbol = function (nm) {
  if (typeof nm === "string") nm = cached_string(nm);
  return comp.Symbol(0, comp.inc_refs(nm));
}
...
const off_check_local_free = pre_new_method(1, 0, 0, wasm.i32, {},
  function (val) {
    return [
      // if external, skip
      wasm.local$get, ...val,
      ...
      wasm.if, wasm.i32,
        wasm.i32$const, 0,
      wasm.else,
        // else set local_free to 0 and return previous value
        wasm.local$get, ...val,
        wasm.i32$const, ...sleb128i32(local_flag),
        wasm.i32$const, 0,
...
const set_local_free_derived = pre_new_method(
...
const set_local_free_external = pre_new_method(
  2, 0, 0, wasm.i32, {}, function (val, on) {
    return [
      wasm.local$get, ...val,
      wasm.i32$const, ...sleb128i32(external_flag),
...
const local_free_is_external = pre_new_method(
...
funcs.build(
  [wasm.i32, wasm.i32, wasm.i32], [wasm.i32], { comp: "for-each" },
  function (coll, accum, func) {
    return [
      wasm.local$get, ...coll,
      wasm.local$get, ...accum,
      wasm.i32$const, 0,
...
// todo: implement in comp after fixing loop
//funcs.build(
//  [wasm.i32, wasm.i32], [wasm.i32], { comp: "map!" },
//  function (func, coll) {
//    const cnt = this.local(wasm.i32),
//          idx = this.local(wasm.i32),
//          arr = this.local(wasm.i32);
...
const lookup_global = funcs.build(
  ...
  function (var_name) {
    return [
//wasm.i32$const, ...sleb128i32(50592),
...
const new_env = funcs.build(
  ...
  function (prev_env) {
    ...
    return [
      ...
      wasm.i32$const, 0,
      wasm.call, ...array_by_length.uleb128,
// todo: should be calling comp_atom here or just Atom.constr?
...
const free_env_leaf_func = comp.Function(
  free_env_leaf.func_idx,
  add_to_func_table(free_env_leaf.func_idx),
  get_type_idx(2, 0, 0, wasm.i32),
  wasm.i32, 2, 0, 0, 0,
);
...
//    return [
//      wasm.local$get, ...env,
//      wasm.i32$const, ...sleb128i32(free_env_leaf_func),
//      wasm.call, ...for_each.uleb128,
//      wasm.drop,
//      wasm.local$get, ...env,
//      wasm.call, ...free.uleb128
    ...
    return [
      ...
      wasm.loop, wasm.void,
        ...
        wasm.if, wasm.void,
          ...
          wasm.i32$const, ...sleb128i32(wasm.call),
          wasm.call, ...append_code.uleb128,
          wasm.i32$const, ...lookup_global.sleb128,
          wasm.call, ...append_varuint32.uleb128,
          wasm.i32$const, ...sleb128i32(wasm.call),
          wasm.call, ...append_code.uleb128,
...
const add_scope = funcs.build(
  ...
  function (outer_func, inner_func, outer_env, inner_env, scope, local_idx) {
    ...
    return [
      ...
      wasm.local$tee, ...cnt,
      wasm.if, wasm.void,
        wasm.i32$const, ...sleb128i32(make_symbol("list")),
        wasm.local$get, ...scope,
...
const comp_func_set_params = funcs.build(
  ...
  {},
  function (outer_func, inner_func, config, outer_env, inner_env) {
...
function def_special_form (nm, fn) {
  ...
  // avoids exception in lookup_global
...
const free_local = funcs.build(
  ...
  function (local) {
    return [
      ...
      wasm.call, ...off_check_local_free.uleb128,
      wasm.if, wasm.void,
        wasm.local$get, ...local,
        wasm.call, ...free.uleb128,
      wasm.end,
...
const off_check_local_free_params = funcs.build(
  ...
  function (params, func, env) {
    ...
    return [
      ...
      wasm.call, ...array_by_length.uleb128,
      wasm.local$set, ...arr,
      // start from idx 2 so return val is at start of arr
      // this allows reversion of local_free of param to
      // override reversion of local val
      wasm.i32$const, 2,
      wasm.local$set, ...idx,
      wasm.loop, wasm.i32,
        wasm.local$get, ...idx,
        ...
        wasm.if, wasm.i32,
          ...
          wasm.call, ...nth.uleb128,
          wasm.i32$const, nil,
// todo: why can't we just use idx / 2 as the param_idx?
          wasm.call, ...get.uleb128,
          wasm.call, ...types.Int.fields.value.uleb128,
          wasm.i32$wrap_i64,
...
// todo: this should be return type of func
    ...
    //wasm.call, ...append_varuint32.uleb128,
//wasm.local$get, ...func_num,
//wasm.i32$const, ...sleb128i32(1268),
//wasm.i32$eq,
//wasm.if, wasm.void,
//wasm.local$get, ...func_idx,
//wasm.call, ...print_code.uleb128,
//wasm.end,
    wasm.call, ...end_func.uleb128,
    wasm.local$get, ...inner_env,
...
def_special_form("do", function (func, forms, env) {
  const result = this.local(wasm.i32);
  return [
    // prevent prematurely freeing original forms
    wasm.local$get, ...forms,
    wasm.call, ...inc_refs.uleb128,
    wasm.drop,
    wasm.local$get, ...env,
...
const expand_form = new_method(2, wasm.i32,
  { comp: "expand-form" }, (form, env) => [
    wasm.local$get, ...form,
  ]
);

const free_expanded = new_method(
  1, null, {}, form => []
);
...
free_expanded.implement(types.Seq, function (seq) {
  const vec = this.local(wasm.i32);
  return [
    wasm.local$get, ...seq,
    wasm.call, ...count.uleb128,
...
literal_tagged_data.implement(types.Int, function (int) {
  return [
    ...
    wasm.call, ...refs_array_by_length.uleb128,
    wasm.i32$const, 0,
    wasm.i32$const, ...sleb128i32(make_symbol("Int$value")),
    wasm.call, ...refs_array_set.uleb128,
    wasm.i32$const, 1,
    wasm.local$get, ...int,
    wasm.call, ...refs_array_set.uleb128,
...
literal_tagged_data.implement(types.Float, function (flt) {
  return [
    ...
    wasm.call, ...refs_array_by_length.uleb128,
    wasm.i32$const, 0,
    wasm.i32$const, ...sleb128i32(make_symbol("Float$value")),
    wasm.call, ...refs_array_set.uleb128,
    wasm.i32$const, 1,
    wasm.local$get, ...flt,
    wasm.call, ...refs_array_set.uleb128,
